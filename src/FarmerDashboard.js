...
const FarmerDashboard = () => {
    ...
    const handleViewFarmingTools = () => {
        navigate('/farming-tools-page'); // Navigate to the farming tools page
    };
    ...
    return (
        ...
        <div className="dashboard-container">
            ...
            {/* New Section for Subscription Benefits */}
            {isSubscribed && (
            ...
            {isSubscribed ? null : (
               ...
               <div className="subscription-content">
                   ...
                   <div className="subscription-text">
                       ...
                       <li><b>Gain access to a wealth of discounted farming resources, toolsand tips to improve your productivity.</b></li>
